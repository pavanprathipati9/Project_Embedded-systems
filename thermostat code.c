...
__interrupt void TIMER0_A0_ISR (void)
{
    ...
    void intTimers(void);
    {
         ...
         initCcr2Param.compareValue = 0x1000;              // Compare value: 4000 = 1/2 second
         ...
         initUpParam1.timerPeriod = 0x6000;  // Half the time
         ...
         Timer_A_initCompareModeParam initCcr1Param1 = { 0 };
         initCcr1Param1.compareRegister = TIMER_A_CAPTURECOMPARE_REGISTER_1;                 // Use CCR2 for compare
         initCcr1Param1.compareInterruptEnable = TIMER_A_CAPTURECOMPARE_INTERRUPT_DISABLE; // Since directly driving LED, interrupt not req'd
         initCcr1Param1.compareOutputMode = TIMER_A_OUTPUTMODE_TOGGLE_RESET;        // Toggle provides a 1 sec period based on CCR0 and CCR2 values
         initCcr1Param1.compareValue = 0x0100;                // Compare value: 4000 = 1/2 second

         Timer_A_initCompareMode( TIMER_A1_BASE, &initCcr1Param1 );
